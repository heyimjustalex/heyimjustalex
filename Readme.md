...
## 🧬 Tech stack
![My Skills](https://skillicons.dev/icons?i=jenkins,ansible,aws,py,bash,nginx,docker,kubernetes,cloudflare,fastapi,cs,react,nextjs,js,html,css,rabbitmq,mysql,sequelize,postgres,nodejs,git,github,gitlab&perline=80)
